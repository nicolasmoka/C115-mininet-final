...
**Comando:** tcpdump -XX -n -i h1-eth0
              
**Comando:** tcpdump -XX -n -i h2-eth0
...
**Comando:** iperf -c 10.0.0.1 -p 5555 -i 1 -t 20
             
**Comando:** sudo mn -c
             
**Comando:** sudo mn --topo=tree,depth=3,fanout=5 --mac --link-tc,bw=40
